(function(k, d) { "object" === typeof exports && "undefined" !== typeof module ? d(exports, require("three")) : "function" === typeof define && define.amd ? define(["exports", "three"], d) : (k = k || self, d(k.PANOLENS = {}, k.THREE)) })(this, function(k, d) {
    ...
    function ca(a, b) {
        ...
        var f = this,
            ...
            P = 0,
            H, U = !1,
            G, J, K, L, v = { NONE: -1, ROTATE: 0, DOLLY: 1, PAN: 2, TOUCH_ROTATE: 3, TOUCH_DOLLY: 4, TOUCH_PAN: 5 },
            w = v.NONE;
        ...
        this.getLastPosition = function() { return M };
        ...
        this.momentum =
            function() { U && (1E-4 > Math.abs(O) && 1E-4 > Math.abs(P) ? U = !1 : (P *= this.momentumDampingFactor, O *= this.momentumDampingFactor, C -= this.momentumScalingFactor * O, B -= this.momentumScalingFactor * P)) };
        ...
        this.getPolarAngle = function() { return I };
        this.getAzimuthalAngle = function() { return V };
    ...
    function da(a, b) {
        ...
        var n = function(a) { c.deviceOrientation = a },
            l = function() { c.screenOrientation = window.orientation || 0 },
            x = function(a) {
                a.preventDefault();
                a.stopPropagation();
                h = a.touches[0].pageX;
        ...
        this.updateAlphaOffsetAngle = function(a) { this.alphaOffsetAngle = a };
        this.updateRotX = function(a) { g = a };
        this.rotateLeft = function(a) { this.updateAlphaOffsetAngle(this.alphaOffsetAngle - a) };
        this.rotateUp = function(a) { this.updateRotX(g + a) };
    ...
    function ia(a) {
        ...
        p = new d.Mesh(p, h);
        c.add(p);
        this.setEyeSeparation = function(a) { e.eyeSep = a };
    ...
    var ja = "^0.105.2".replace(/[^0-9.]/g, ""),
        ...
        fa = {
            load: function(a, b, c, e) {
                ...
                g.addEventListener("loadend", function(a) { a && (h = new Uint8Array(a.currentTarget.response), p = new window.Blob([h]), m.addEventListener("load", f, !1), m.src = k.createObjectURL(p)) });
                g.send(null)
            }
        },
        K = {
    ...
    Y.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
        ...
        getDevices: function(a) { a = void 0 === a ? "video" : a; var b = this.devices; return this.enumerateDevices().then(function(a) { return a.map(function(a) { b.includes(a) || b.push(a); return a }) }).then(function(b) { var e = new RegExp(a, "i"); return b.filter(function(a) { return e.test(a.kind) }) }) },
    ...
    Object.assign(F.prototype, {
        ...
        updateTextureToLeft: function(a) { a.copy(this.loffset) },
        updateTextureToRight: function(a) { a.copy(this.roffset) }
    });
    ...
    var m = function(a, b) { return b = { exports: {} }, a(b, b.exports), b.exports }(function(a, b) {
        ...
        c.now = "undefined" === typeof self && "undefined" !== typeof process &&
            process.hrtime ? function() { var a = process.hrtime(); return 1E3 * a[0] + a[1] / 1E6 } : "undefined" !== typeof self && void 0 !== self.performance && void 0 !== self.performance.now ? self.performance.now.bind(self.performance) : void 0 !== Date.now ? Date.now : function() { return (new Date).getTime() };
        ...
        c.Easing = {
            ...
            Cubic: { In: function(a) { return a * a * a }, Out: function(a) { return --a * a * a + 1 }, InOut: function(a) { return 1 > (a *= 2) ? .5 * a * a * a : .5 * ((a -= 2) * a * a + 2) } },
            ...
            Quintic: {
                ...
                InOut: function(a) { return 1 > (a *= 2) ? .5 * a * a * a * a * a : .5 * ((a -= 2) * a * a * a * a + 2) }
            },
            ...
            Exponential: { In: function(a) { return 0 === a ? 0 : Math.pow(1024, a - 1) }, Out: function(a) { return 1 === a ? 1 : 1 - Math.pow(2, -10 * a) }, InOut: function(a) { return 0 === a ? 0 : 1 === a ? 1 : 1 > (a *= 2) ? .5 * Math.pow(1024, a - 1) : .5 * (-Math.pow(2, -10 * (a - 1)) + 2) } },
            Circular: {
                In: function(a) {
                    return 1 -
                        Math.sqrt(1 - a * a)
                ...
                InOut: function(a) { return 1 > (a *= 2) ? -.5 * (Math.sqrt(1 - a * a) - 1) : .5 * (Math.sqrt(1 - (a -= 2) * a) + 1) }
            },
            Elastic: {
                In: function(a) { return 0 === a ? 0 : 1 === a ? 1 : -Math.pow(2, 10 * (a - 1)) * Math.sin(5 * (a - 1.1) * Math.PI) },
                Out: function(a) { return 0 === a ? 0 : 1 === a ? 1 : Math.pow(2, -10 * a) * Math.sin(5 * (a - .1) * Math.PI) + 1 },
                InOut: function(a) {
                    if (0 === a) return 0;
                    if (1 === a) return 1;
                    a *= 2;
            ...
            Bounce: {
                ...
                Out: function(a) { return a < 1 / 2.75 ? 7.5625 * a * a : a < 2 / 2.75 ? 7.5625 * (a -= 1.5 / 2.75) * a + .75 : a < 2.5 / 2.75 ? 7.5625 * (a -= 2.25 / 2.75) * a + .9375 : 7.5625 * (a -= 2.625 / 2.75) * a + .984375 },
                InOut: function(a) {
        ...
        c.Interpolation = {
            ...
            Bezier: function(a, b) { for (var e = 0, g = a.length - 1, d = Math.pow, l = c.Interpolation.Utils.Bernstein, k = 0; k <= g; k++) e += d(1 - b, g - k) * d(b, k) * a[k] * l(g, k); return e },
            ...
            Utils: {
                ...
                Bernstein: function(a, b) { var e = c.Interpolation.Utils.Factorial; return e(a) / e(b) / e(a - b) },
                Factorial: function() { var a = [1]; return function(b) { var c = 1; if (a[b]) return a[b]; for (var e = b; 1 < e; e--) c *= e; return a[b] = c } }(),
    ...
    y.prototype = Object.assign(Object.create(d.Sprite.prototype), {
        ...
        setElementStyle: function(a, b, c) { b = b.style; "transform" === a && (b.webkitTransform = b.msTransform = b.transform = c) },
    ...
    L.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
        ...
        createVideoControlSeekbar: function() {
            ...
            function b(a) { d && (l = ((a.clientX || a.changedTouches && a.changedTouches[0].clientX) - p) / f.clientWidth, l = n + l, l = 1 < l ? 1 : 0 > l ? 0 : l, f.setProgress(l), g.dispatchEvent({ type: "panolens-viewer-handler", method: "setVideoCurrentTime", data: l })) }
            ...
            f.appendChild(k);
            f.setProgress = function(a) { k.style.width = 100 * a + "%" };
        ...
        createMenuItem: function(a) {
            ...
            c.setSelectionTitle = function(a) { this.selection && (this.selection.textContent = a) };
        ...
        createCustomItem: function(a) {
            ...
            c.dispose = function() { c.removeEventListener(b.TOUCH_ENABLED ? "touchend" : "click", a.onTap, !1); if (e) a.onDispose() };
            return c
        },
    ...
    r.prototype = Object.assign(Object.create(d.Mesh.prototype), {
        constructor: r,
        createGeometry: function(a) { return new d.BoxBufferGeometry(a, a, a) },
        ...
        add: function(a) {
            ...
            a instanceof y && ((b = this.container) && a.dispatchEvent({
                ...
                container: b
            }), a.dispatchEvent({ type: "panolens-infospot-focus", method: function(a, b, d) { this.dispatchEvent({ type: "panolens-viewer-handler", method: "tweenControlCenter", data: [a, b, d] }) }.bind(this) }));
            d.Object3D.prototype.add.call(this, a)
        },
        getTexture: function() { return this.material.uniforms.tEquirect.value },
        ...
        setContainer: function(a) {
            ...
            b && (this.children.forEach(function(a) { a instanceof y && a.dispatchEvent && a.dispatchEvent({ type: "panolens-container", container: b }) }), this.container = b)
        },
        onLoad: function() {
            this.loaded = !0;
            this.dispatchEvent({ type: "load" })
        },
        onProgress: function(a) { this.dispatchEvent({ type: "progress", progress: a }) },
        ...
        updateTexture: function(a) { this.material.uniforms.tEquirect.value = a },
        toggleInfospotVisibility: function(a, b) {
            b = void 0 !== b ? b : 0;
            var c = void 0 !== a ? a : this.isInfospotVisible ? !1 : !0;
            this.traverse(function(a) { a instanceof y && (c ? a.show(b) : a.hide(b)) });
        ...
        setupTransitions: function() {
            ...
            this.enterTransition =
                (new m.Tween(this)).easing(m.Easing.Quartic.Out).onComplete(function() { this.dispatchEvent({ type: "enter-complete" }) }.bind(this)).start();
    ...
    u.prototype = Object.assign(Object.create(r.prototype), {
        ...
        reset: function() { r.prototype.reset.call(this) },
        dispose: function() {
    ...
    R.prototype = Object.assign(Object.create(r.prototype), {
        ...
        createMaterial: function() { new d.MeshBasicMaterial({ color: 0, opacity: 0, transparent: !0 }) },
    ...
    M.prototype = Object.assign(Object.create(r.prototype), {
        ...
        load: function() { ha.load(this.images, this.onLoad.bind(this), this.onProgress.bind(this), this.onError.bind(this)) },
        onLoad: function(a) {
            this.material.uniforms.tCube.value = a;
            r.prototype.onLoad.call(this)
        },
        getTexture: function() { return this.material.uniforms.tCube.value },
        dispose: function() {
            var a = this.material.uniforms.tCube.value;
            this.images.forEach(function(a) { d.Cache.remove(a) });
        ...
        load: function() {
            ...
            d = function() {
                ...
                this.isMobile() && (h.pause(),
                    e && b ? this.dispatchEvent({ type: "panolens-viewer-handler", method: "updateVideoPlayButton", data: !1 }) : this.dispatchEvent({ type: "panolens-viewer-handler", method: "updateVideoPlayButton", data: !0 }));
                window.requestAnimationFrame(function() {
                    k({ loaded: 1, total: 1 });
                    m(a)
                })
            ...
            h.addEventListener("ended", function() { c || (this.resetVideo(), this.dispatchEvent({ type: "panolens-viewer-handler", method: "updateVideoPlayButton", data: !0 })) }.bind(this), !1)
        },
        onLoad: function() { r.prototype.onLoad.call(this) },
    ...
    Object.assign(Z.prototype, {
        ...
        composePanorama: function() {
            ...
            for (var e = this._parameters.useWebGL, d =
                    0; d < b; d++)
                for (var h = {}, k = 0; k < a; h = { $jscomp$loop$prop$url$2: h.$jscomp$loop$prop$url$2 }, k++) h.$jscomp$loop$prop$url$2 = "https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom=" + this._zoom + "&x=" + k + "&y=" + d + "&panoid=" + this._panoId + "&nbt&fover=2",
                    function(a) {
                        return function(b, d) {
                            if (e) var g = K.load(a.$jscomp$loop$prop$url$2, null, function() { c.composeFromTile(b, d, g) });
                            else {
                                var f = new Image;
                                f.addEventListener("load", function() { c.composeFromTile(b, d, this) });
                                f.crossOrigin = "";
                                f.src =
        ...
        loadPano: function(a) {
            var b = this;
            this._panoClient.getPanoramaById(a, function(a, e) { e === google.maps.StreetViewStatus.OK && (b.result = a, b.copyright = a.copyright, b._panoId = a.location.pano, b.composePanorama()) })
        },
        setZoom: function(a) {
            this._zoom = a;
    ...
    aa.prototype = Object.assign(Object.create(u.prototype), {
        ...
        onLoad: function(a) { u.prototype.onLoad.call(this, new d.Texture(a)) },
        reset: function() {
    ...
    B.prototype = Object.assign(Object.create(u.prototype), {
        ...
        createGeometry: function(a) { return new d.PlaneBufferGeometry(a, .5 * a) },
    ...
    T.prototype =
        Object.assign(Object.create(r.prototype), { constructor: T, onPanolensContainer: function(a) { this.media.setContainer(a.container) }, onPanolensScene: function(a) { this.media.setScene(a.scene) }, start: function() { return this.media.start() }, stop: function() { this.media.stop() } });
    ...
    ea.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
        constructor: ea,
        setupScene: function(a) { return a = void 0 === a ? new d.Scene : a },
        ...
        toggleVideoPlay: function(a) { this.panorama instanceof z && this.panorama.dispatchEvent({ type: "video-toggle", pause: a }) },
        setVideoCurrentTime: function(a) { this.panorama instanceof z && this.panorama.dispatchEvent({ type: "video-time", percentage: a }) },
        ...
        rotateControlLeft: function(a) { this.control.rotateLeft(a) },
        rotateControlUp: function(a) { this.control.rotateUp(a) },
        ...
        tweenControlCenterByObject: function(a, b, c) { this.tweenControlCenter(a.getWorldPosition(new d.Vector3), b, c) },
        onWindowResize: function(a, b) {
            ...
            this.scene.traverse(function(a) { a.dispatchEvent && a.dispatchEvent({ type: "window-resize", width: e, height: d }) })
        },
        ...
        onMouseUp: function(a) {
            ...
            if (!a || !a.target || a.target.classList.contains("panolens-canvas"))
                if (a.preventDefault(), a = a.changedTouches && 1 === a.changedTouches.length ? this.onTap({ clientX: a.changedTouches[0].clientX, clientY: a.changedTouches[0].clientY },
        ...
        onTap: function(a, b) {
            ...
            if (this.panorama) {
                ...
                if (g && g instanceof y) { if (this.infospot = g, "click" === b) return !0 } else this.infospot && this.hideInfospot();
        ...
        onKeyDown: function(a) { this.options.output && "none" !== this.options.output && "Control" === a.key && (this.outputEnabled = !0) },
